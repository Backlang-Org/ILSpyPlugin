...
namespace Backlang.Ilspy
{
    public static class Colors
    {
        ...
        public static readonly HighlightingColor AnnotationColor = new HighlightingColor { Foreground = new SimpleHighlightingBrush(System.Windows.Media.Colors.LawnGreen) };
